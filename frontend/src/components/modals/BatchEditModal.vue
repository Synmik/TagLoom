    ...
    <div class="modal">
      ...
      <div class="modal-body">
          ...
          <div v-if="pickerMode === 'add'" class="tag-picker">
            ...
            <div class="picker-results">
              <div
                ...
                @click="createTag"
              >
                <PlusCircle :size="14" class="create-icon" /> Create "<strong>{{
                  searchQuery
                }}</strong
                >"
              </div>
        ...
        <div class="form-group checkbox">
          <label>
            <input v-model="favoriteAction" type="radio" :value="'unset'" />
            Leave favorites unchanged
          </label>
          <label>
            <input v-model="favoriteAction" type="radio" :value="'set'" />
            Set as favorite
          </label>
          <label>
            <input v-model="favoriteAction" type="radio" :value="'unset_flag'" />
            Remove favorite
          </label>
        </div>
        ...
        <div class="actions-row">
          <button class="save-btn" :disabled="nothingToApply" @click="apply">
