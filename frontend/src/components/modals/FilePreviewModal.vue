      ...
      <div v-else-if="isVideo" class="video-wrapper">
        ...
        <div class="video-controls">
          ...
          <div class="controls-row">
            <button class="ctrl-btn" :title="isPlaying ? 'Pause' : 'Play'" @click="togglePlayPause">
            ...
            >
              <button class="ctrl-btn" :title="isMuted ? 'Unmute' : 'Mute'" @click="toggleMute">
            ...
            <button class="ctrl-btn" title="Picture in Picture" @click="togglePiP">
              <PictureInPicture2 :size="18" />
            </button>
            <button class="ctrl-btn" title="Fullscreen" @click="toggleFullscreen">
              <Maximize :size="18" />
            </button>
          </div>
        </div>
